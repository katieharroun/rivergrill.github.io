	...
	<div>
		<div id="hhmenu">
			...
			<ul class="clearfix">
				...
				<div>
					...
					<li>Blackstone Merlot</li>
					<li>Snapdragon Pinot Noir</li>
					<li>Lange Twins Cabernet</li>
					<h5>White:</h5>
		...
		<hr>
			<div class="foodwrap">
				...
				<h6>Shrimp Taco</h6>
				<p>spinach, cheese, shrimp and cabbage rolled in a large flour tortilla and grilled, served with guacamole and pico de gallo (two tacos per order)</p>
				<p>$16</p>
				<h6>Smoked Baby Back Ribs</h6>
				<p>with coleslaw and BBQ sauce</p>
				<p>$16</p>
				<h6>Pulled Pork Sliders</h6>
				<p>two sliders with pineapple and cabbage slaw</p>
				<p>$12</p>
				<h6>Ceviche</h6>
				<p>tilapia with mango pineapple salsa and corn tortilla chips</p>
				<p>$13</p>
		...
		<hr>	
				<div class="left">
					...
					<p>jicama citrus relish, spring roll, wasabi and soy</p>
					<p>$17</p>
					<h6>Crispy Fried Calamari</h6>
					<p>with chipotle aioli and cocktail sauce</p>
					<p>$12</p>
					<h6>Prawn Dynamite</h6>
					<p>crispy, sweet, hot, and spicy with cilantro and green onions</p>
					<p>$13</p>
				...
				<div class="right">
					...
					<p>applewood smoked bacon, tomatoes, N.Y. sharp white cheddar</p>
					<p>$10</p>
					<h6>River Grill Spring Roll</h6>
					<p>with edamame beans and ponzu dip</p>
					<p>$9</p>
					<h6>Spicy Chicken Enchilada</h6>
					<p>guacamole, roasted chili crema and Feta cheese</p>
					<p>$11</p>
					<h6>Four Mini Crab Cakes</h6>
					<p>topped with chipotle aioli</p>
					<p>$13</p>
				</div>
			</div>	
		<hr>
		...
		<hr>		
				<div id="salads">
					...
					<p>with baby greens and sherry vinaigrette</p>
					<p>$11</p>
					<h6>Caesar Salad</h6>
					<p>(ask for without croutons for gluten free)</p>
					<p>$9</p>
					<h6>Farmers Market Salad</h6>
					<p>baby greens, marinated sugar plum tomatoes, sherry vinaigrette</p>
					<p>$9</p>
					<h6>Add chicken to any salad</h6><p>$8</p>
					<h6>Today's Soup</h6>
					<p>bowl  $8,  cup  $5</p>
				</div>
			</div>	
		...
		<hr>	
				<div class="left">
					...
					<p>boneless ribs, gratin potatoes, steamed broccoli, cabernet demi </p>
					<p> $31</p>
					<h6>Grilled Fresh Salmon</h6>
					<p>baby bok choy, edamame beans, shiitake mushrooms, sesame ginger vinaigrette </p>
					<p> $27</p>
					<h6>Green Chard Raviolis</h6>
					<p>sonoma goat cheese, roasted garlic, portabella mushroom, rustic tomato sauce </p>
					<p> $19</p>
					<h6>Beef Tenderloin Filet</h6>
					<p>whipped potatoes, sauteed spinach, cabernet demi </p>
					<p> $32</p>
				</div>	
				<div class="right">
					<h6>Roasted Moscovy Duck Breast</h6>
					<p>gingered whipped sweet potatoes, grilled asparagus, cabernet demi</p>
					<p>  $29</p>
					<h6>Stuffed Chicken Breast</h6>
					<p>stuffed with arugula, cheddar and prosciutto, served with whipped potaoes, grilled asparagus and cabernet demi</p>
					<p>  $23</p>
					<h6>Grilled Pork Rack Chop</h6>
					<p>celery root puree, carmelized apples, sauteed kale, bourbon bbq sauce</p>
					<p>$26</p>
		...
		<hr>
			...
			<div id="dessertmen">
					...
					<h2>Ice Cream</h2>
					<p>Choice of Vanilla, Dulce de Leche, Coffee or Raspberry Sorbet</p>
			</div>
	</div>	
	<hr>
	<div id="wine">
